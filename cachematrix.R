...
# ---- cacheSolve ----------------------------------------------------
## Check if the inverse of the cached matrix has already been 
## calculated. If so, return it, otherwise, caculate the inverse,
## store it in the cached matrix and return it. 
